...
```{r barIncome, echo=FALSE, fig.cap="Distribution of Population by Area"}
knitr::include_graphics("www/05_graficas/03_bar_pers.png")
```
...
```{r histIncome, echo=FALSE, fig.cap="Distribution of Population Income"}
knitr::include_graphics("www/05_graficas/01_hist_ingreso.png")
```
...
```{r HistIncomeExpenditureSex, echo=FALSE, fig.cap= "Histograms of Income and Expenditure by Sex"}
knitr::include_graphics("www/05_graficas/02_Hist_sex.png")
```
...
```{r ScatterIncome, echo=FALSE, fig.cap= "Weighted scatterplot between income and expenditure"}
knitr::include_graphics("www/05_graficas/02_scatterplot_ingreso_gasto.png")
```
